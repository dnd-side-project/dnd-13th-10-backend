...
public enum Position implements EnumCode  {
    ...
    MARKETING_PR("11", "마케팅·홍보"),
    ACCOUNTING_FINANCE("12", "회계·세무·재무"),
    HR("13", "인사·노무·HRD"),
    ADMIN_LEGAL("14", "총무·법무·사무"),
    DEVELOPMENT_DATA("20", "개발·데이터"),
    DESIGN("21", "디자인"),
    SALES_CUSTOMER("30", "영업·고객관리"),
    PURCHASE_LOGISTICS("31", "구매·자재·물류"),
    DRIVING_DELIVERY("32", "운전·운송·배송"),
    SERVICE("40", "서비스"),
    CONSTRUCTION_ARCHITECTURE("50", "건설·건축"),
    FINANCE_INSURANCE("60", "금융·보험"),
    PUBLIC_WELFARE("70", "공공·복지");
